...

 {
    ...
    */
...

    {
        ...
        $validator = Validator::make($request->all(), ['image_file1'=> 'nullable|image|mimes:jpeg,jpg,png,gif,jfif,heic']);
        ...
        $validator = Validator::make($request->all(), ['image_file2'=> 'nullable|image|mimes:jpeg,jpg,png,gif,jfif,heic']);
        ...
        $validator = Validator::make($request->all(), ['image_file3'=> 'nullable|image|mimes:jpeg,jpg,png,gif,jfif,heic']);
        ...
        } $validator = Validator::make($request->all(), ['image_file4'=> 'nullable|image|mimes:jpeg,jpg,png,gif,jfif,heic']);
