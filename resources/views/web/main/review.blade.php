                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <div class="feedback">
                                ...
                                <h2>Write Review</h2>
                                <form id="contact-form" class="contact-form" name="contact-form" method="post" action="{{ route('web.donation.storereview',$user_identity)}}">
                                    <div class="row">
                                        {{csrf_field()}}
                                        <input type="hidden" name="key" value="{{$user_identity}}"/>
                                        <div class="col-sm-12">
                                            <div class="form-group{{ $errors->has('report') ? ' has-error' : '' }}">
                                                <textarea  id="report" name="review_subject" class="form-control" value="{{old('report')}}" rows="7" placeholder="Report message ?"></textarea>
